...
ПРИВЕТСТВИЕ — в САМОМ ПЕРВОМ своём сообщении диалога, одним словом и сразу к делу:
«Здравствуйте! ...». Отдельным сообщением здороваться не надо, и во всех последующих
ответах не здоровайся повторно.
